...
# MAGIC SELECT 
# MAGIC   --COALESCE(last_processed_timestamp, CURRENT_TIMESTAMP - INTERVAL 1 DAYS) as watermark_ts
# MAGIC   CURRENT_TIMESTAMP - INTERVAL 1 DAYS  as watermark_ts
...
dbutils.notebook.exit(f"Success: Processed {summary_stats['total_processed']:,} events. Conversions: {summary_stats['conversions_fact_definition']:,}. Identity: {identity_summary}")
